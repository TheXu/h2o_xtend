# -*- coding: utf-8 -*-
"""
Created on Fri May  3 10:04:29 2019
...
def coef_norm(self, category=None):
    """
...
def std_coef_plot(self, category, num_of_features=None, server=False):
    """
    ...
    unsorted_norm_coef = coef_norm(self, category).items()
